...
const ReAssignedIssues = ({route}) => {
  const navigation = useNavigation();
  const [icon, setIcon] = useState();
  const {color, Language, resourceid, resourceName, LanguageOpt} = route.params;
  ...
  console.log(
    'ReAssigned Tickets ASSET DATA ##### ' + JSON.stringify(AssetDetails),
  );
  return (
        ...
        <View style={styles.body}>
          {(() => {
            if (JSON.stringify(AssetDetails) === '[]') {
              return <Text> ReAssigned Tickets Data Not Available</Text>;
              ...
              return (
                <View>
                  <Text
                    ...
                    {' '}
                    Maintanance Status : ReAssigned , Count :
                    {AssetDetails.length}
                  </Text>
                      ...
                      <View style={{marginBottom: 5, marginTop: 5}}>
                        ...
                        <View
                          ...
                          <Text style={styles.text5}>
                            Status:{' '}
                            <Text style={styles.text5}>RE ASSIGNED</Text>
                          </Text>
                        </View>
                      </View>
                    </View>
...
/**  <View>
                  <Text> ReAssigned Tickets count :{AssetDetails.length}</Text>;
...
export default ReAssignedIssues;
