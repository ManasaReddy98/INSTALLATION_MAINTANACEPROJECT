...
const AddDCU = ({selectedUserName,LanguageOpt}) => {
  ...
  const saveFieldDeviceDataToServer = async () => {
    try {
      ...
      var payloadTest = {
        ...
        hardwareVersion: '',
        firmwareVersion: '',
        dcserialNo: deviceDetails.DCU_ID,
        dcimei: deviceDetails.MODEM_IMEI_NO,
        dcphysicalAddress: deviceDetails.PHYSICAL_ADDRESS,
        dcouterBoxNumber: deviceDetails.DC_OUTER_BOX_NO,
        simno: deviceDetails.SIM_ID,
        routerNo: '',
  ...
  return (
    <ImageBackground
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('DCU_ID')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'DCU_ID')}
      />
      <TextInput
        style={styles.textInput} 
        placeholder={LanguageOpt('FIELD_REF_NO')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'FIELD_REF_NO')}
      />
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('DC_BOX_NO')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'DC_BOX_NO')}
      />
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('DC_OUTER_BOX_NO')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'DC_OUTER_BOX_NO')}
      />
       <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('SIM')}
        placeholderTextColor="grey"
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('MODEM_IMEI_NO')}
        placeholderTextColor="grey"
