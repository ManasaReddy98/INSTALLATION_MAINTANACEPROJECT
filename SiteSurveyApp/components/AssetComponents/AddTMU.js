...
const AddTMU = ({selectedUserName,LanguageOpt}) => {
  ...
  const [deviceDetails, setDeviceDetails] = useState({
    ...
    USERNAME: '',
    TMU_SERIAL_N0:'',
    TMU_TYPE:'',MODEM_ADDRESS:'',
    MODEM_DESCRIPTION:'',
    SIM_ID:'',
    TMU_HARDWARE_VERSION:'',
    TMU_FIRMWARE_VERSION:'',
    INSTALLATION_DATE:'',
    COMISSIONING_DATE:'',
    DE_COMISSIONING_DATE:''
  ...
  const saveFieldDeviceDataToServer = async () => {
    try {
      ...
      var payloadTest = {
        ...
        mountType: '',
        utilityRefNo: '',
        tmusno: deviceDetails.TMU_SERIAL_N0,
        tmutype: deviceDetails.TMU_TYPE,
        transformerType: '',
        hardwareVersion: deviceDetails.TMU_HARDWARE_VERSION,
        firmwareVersion: deviceDetails.TMU_FIRMWARE_VERSION,
        dcserialNo: '',
        dcimei: '',
        dcphysicalAddress: '',
        dcouterBoxNumber: '',
  ...
  return (
    <ImageBackground
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('TMU_SERIAL_NO')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'TMU_SERIAL_N0')}       
      />
      {/* <TextInput
        style={styles.textInput}
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('TMU_TYPE')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'TMU_TYPE')}  
      ...
      {/* <TextInput
        style={styles.textInput}
        placeholder="MULTIPLICATION_FACTOR"
        placeholderTextColor="grey"
      /> */}
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('MODEM_ADDRESS')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'MODEM_ADDRESS')}
      />

      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('MODEM_DESCRIPTION')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'MODEM_DESCRIPTION')}
      ...
      <TextInput
        style={styles.textInput}
        placeholder="MFG_DATA"
        placeholderTextColor="grey"
      />
      <TextInput
        style={styles.textInput}
        placeholder="WARRENTY_END"
        placeholderTextColor="grey"
      /> */}
      ...
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('SIM_ID')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'SIM_ID')}
      />
        <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('TMU_HARDWARE_VERSION')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'TMU_HARDWARE_VERSION')}
      />
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('TMU_FIRMWARE_VERSION')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'TMU_FIRMWARE_VERSION')}
      />
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('INSTALLATION_DATE')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'INSTALLATION_DATE')}
      />

      {/* INSTALLATION_DATE,COMISSIONING_DATE,DE_COMISSIONING_DATE */}

      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('COMISSIONING_DATE')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'COMISSIONING_DATE')}
      />
      <TextInput
        style={styles.textInput}
        placeholder={LanguageOpt('DE_COMISSIONING_DATE')}
        placeholderTextColor="grey"
        onChangeText={text => handleOnchange(text, 'DE_COMISSIONING_DATE')}
      />
