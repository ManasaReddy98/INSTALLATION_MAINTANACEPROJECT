...
const Resolved = ({route}) => {
  ...
  console.log(
    'RESOLVED ISSUES ASSET DATA ##### ' + JSON.stringify(AssetDetails),
  );
        ...
        <View>
          {(() => {
            if (JSON.stringify(AssetDetails) === '[]') {
              return <Text> Resolved Tickets Data Not Available</Text>;
              ...
              return (
                <View>
                  <Text
                    ...
                    {' '}
                    Maintanance Status : Resolved , Count :{AssetDetails.length}
                  </Text>
