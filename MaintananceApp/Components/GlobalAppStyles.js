...
export default StyleSheet.create({
    ...
    dashboardmenutext: {
        color: '#3a4a64', fontSize: 12, fontWeight: "100", marginTop: 12,
    ...
    */
    ...
    radioText: {
        color: '#003f5c', fontWeight: '300', alignItems: 'center', paddingTop: 2, fontSize: 15
    },
    radioTextForgetPassword: {
        color: '#fff', fontWeight: '300', justifyContent: 'center', alignItems: 'center', alignSelf: 'center', paddingTop: 2, fontSize: 15
    },
    radioCircle: {
        height: 23,
        width: 23,
    ...
    processCircle: { // this shape is a circle
        height: 50,
        width: 50,
        borderRadius: 50,
        margin: 10,
    ...
    legendView: {
        flex: 0.5, flexDirection: 'row', justifyContent: 'center', marginTop: 10,
    },

    legendTouchableOpacity1: {
        backgroundColor: '#e36415', width: 15, height: 15, marginTop: 5,
    },
    legendTouchableOpacity2: {
        backgroundColor: '#375e27', width: 15, height: 15, marginTop: 5,
    },
    legendTouchableOpacity3: {
        backgroundColor: '#406278', width: 15, height: 15, marginTop: 5,

    },
    legendText: {
        color: '#fff', fontSize: 15, fontWeight: "500",marginTop:5
    },
    assetDataIconStyle: { width: 25, height: 25, borderRadius: 20, marginRight: 10, alignItems: "center" },
