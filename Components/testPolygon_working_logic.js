...
// const polygonCordinatesByDC = [
//     {latitude:17.395676,longitude:78.427914},
//     {latitude:17.396194,longitude:78.426545},
//     {latitude:17.396522,longitude:78.423799},
//     {latitude:17.396686,longitude:78.422082},
//     {latitude:17.397013,longitude:78.421352}]
  ...
  return (
    <View >
      ...
      {(() => {
              if (polygonCordinatesByDC.length>0){
                  return (
                    <View>
                    ...
                    >
                        ...
                        <Polygon
                        coordinates={polygonCordinatesByDC}
                        ...
                        {polygonCordinatesByDC.map((coordinate, index) => (
                    ...
                    return(<View><Text> No Map Data Available </Text></View>)
              }
