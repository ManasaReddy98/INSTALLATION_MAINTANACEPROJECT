...
import GlobalStyles from '../GlobalAppStyles';
...
function MaintananceCaptureSignature({navigation, route}) {
  const {
    color,
    Language,
    AssetDetails,
  ...
  console.log(
    'MAIN CAPTURE SIGNATURE PAGE ######### ' + existingAssetId,
    getid,
    resourceid,
  );
  ...
  const saveFieldInstallationDataToServer = async () => {
    ...
    if (validated_data == 'false') {
      ...
      try {
        ...
        const payload = {
          maintenancedOn: workEndedDateTime,
          sts: workEndedDateTime,
          maintenanceType: 'CON_000033',
          remarks: installationRemarks,
          createdBy: resourceid,
          oldReading: oldReading,
          technicianId: resourceid,
          approvedByUsername: 'EFICAA ENSMART',
          approvalStatus: 'CON_000067',
          approvalRemarks: 'REMARKS',
          approvedOn: workEndedDateTime,
          servicenumber: serviceNumber,
          sopId: '1234',
          geoLatitude: String(latitudeCaptured), //currentLocation?.latitude,
          geoLongitude: String(longitudeCaptured), //currentLocation?.longitude,
          assetMainStatusCode: 'CON_000067',
          actionTakenOn: workEndedDateTime,
          fileContent: deviceImageCaptured, //base64image,
          resourceSign: signatureImage,
        };
        console.log('INSTALLATION  SAVE URL ' + url);
        //  console.log('MAINTANANCE  Payload ' + JSON.stringify(payload));
        const response = await todoService.createAsset(url, payload);
        console.log(
          'Create Issue RESPONSE STATUS FRM SIGNATURE PG  : ' + response.status,
        );
        setLoading('false');
        ...
        if (
          ...
          Alert.alert(
            LanguageOpt('main_success_msg1'),
            LanguageOpt('main_success_msg2'),
            [
              {
                text: LanguageOpt('OK'),
                onPress: () =>
      ...
      <View style={{marginTop: 20}}>
        <ScrollView style={{marginBottom: 100}}>
          ...
          <View>
            ...
            <Text style={{marginLeft: 22}}> Example : 0216 123456</Text>
            ...
            <View
              ...
              <Text
                ...
                {' '}
                {LanguageOpt('Enter_Maintanance_Remarks')}{' '}
              </Text>
              <TextInput
                style={{
                  paddingLeft: 10,
            ...
            <View
              ...
              <TextInput
                ...
                placeholder={LanguageOpt('Enter_Old_Reading')}
              />
            </View>
...
export default MaintananceCaptureSignature;
