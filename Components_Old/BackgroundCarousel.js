            ...
            <View style={{ height: 100, width: DEVICE_WIDTH }}>
                ...
                >
                    {images.map((image, index) => (
                        <View style={{ width: DEVICE_WIDTH, marginTop: 5 }} >

                            <Text style={{ color: '#fff', alignSelf: 'center' }}>{image.name}</Text>
                            <Text style={{ color: '#fff', alignSelf: 'center' }}>{image.name1}</Text>
                            <Text style={{ color: '#fff', alignSelf: 'center' }}>{image.name2}</Text>
                        </View>
                    ))}
                </ScrollView>
